...
def get_args():
    ...
    parser.add_argument('--hidden_dim_H', default=125, type=int, help='hidden dimension width of mlp for Gradient of H')
    parser.add_argument('--hidden_dim_R', default=125, type=int, help='hidden dimension width of mlp for R')
    ...
    parser.add_argument('--nonlinearity', default='tanh', type=str, help='activation function')
    parser.add_argument('--noise', default=0., type=float, help='noise for the training data')
    parser.add_argument('--seed', default=0, type=int, help='randomness seed')
    parser.add_argument('--batch_size', default=32, type=int, help='size of batches for training')
